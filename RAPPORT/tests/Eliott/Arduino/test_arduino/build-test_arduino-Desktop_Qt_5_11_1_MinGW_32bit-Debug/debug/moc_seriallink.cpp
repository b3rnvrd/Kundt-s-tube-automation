...
#include "../../test_arduino/seriallink.h"
...
QT_MOC_LITERAL(1, 11, 10), // "gotNewData"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 4), // "data"
QT_MOC_LITERAL(4, 28, 7) // "newData"

    },
    "seriallink\0gotNewData\0\0data\0newData"
};
...
void seriallink::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->gotNewData((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&seriallink::gotNewData)) {
                *result = 0;
                return;
            }
        }
